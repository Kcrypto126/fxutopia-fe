...
const OFFERS = [
  {
    featured_img: "/assets/about-us/about-card-1.png",
  ...
  {
    featured_img: "/assets/about-us/about-card-2.png",
  ...
  {
    featured_img: "/assets/about-us/about-card-3.png",
      ...
      <div className="space-y-8 md:space-y-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 xl:gap-8">
          {OFFERS.map((item, index) => (
            <div
              key={index}
              className="flex flex-col gap-3 bg-[#381E5B] rounded-[20px] mx-auto p-4 md:py-9 w-full max-w-[464px]"
            >
              <Image
