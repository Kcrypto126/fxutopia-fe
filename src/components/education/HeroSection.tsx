  ...
  return (
    <div className="relative overflow-hidden px-3">
      ...
      <Image
        ...
        height={560}
        alt="left"
        className="absolute bottom-0 left-[50%] -translate-x-[50%] -z-20 min-w-[1600px]"
      />
      ...
      <div className="max-w-[1440px] w-full mx-auto min-h-screen md:min-h-[834px] relative flex flex-col items-center justify-center gap-3">
        <h1 className="max-w-[1080px] lg:!text-[80px] !leading-[110%] md:!leading-[105%] bg-gradient-to-r from-[#4E4EE41A] via-[#ffffff] to-[#4E4EE41A] bg-clip-text text-transparent">
          {data.title}
        </h1>
