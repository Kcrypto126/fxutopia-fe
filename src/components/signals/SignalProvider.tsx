...
const SignalProvider = ({ data }: { data: SignalProps }) => {
  return (
    <Link href="/signals/signal">
      <div className="w-full flex flex-col gap-6 lg:gap-8 p-4 xl:p-8 rounded-[20px] bg-gradient-to-b from-[#2B0A47] to-[#09030E] border-[1px] border-[#361056] hover:bg-none hover:bg-[#2B0A47] cursor-pointer transition-all duration-300">
        <div className="flex flex-col gap-4 lg:gap-6">
          ...
          <div className="flex items-center flex-wrap gap-3">
            ...
            <div className="h-7 lg:h-10 flex items-center justify-center gap-2 px-2 lg:px-4 text-[14px] bg-transparent border-[1px] border-[#FFFFFF] rounded-full">
