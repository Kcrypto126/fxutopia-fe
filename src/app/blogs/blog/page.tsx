...
const Blog = () => {
  return (
    <Container className="py-20 lg:pt-48 lg:pb-32">
      <div className="flex flex-col lg:flex-row justify-between gap-8 lg:gap-31">
        <div className="w-full flex flex-col gap-3 md:gap-11">
          ...
          <div className="flex flex-col gap-8 lg:gap-10">
            ...
            <Image
              ...
              height={510}
              alt="blog"
              className="rounded-[12px] md:rounded-[38px]"
            />
            <div
        ...
        <div className="max-w-[464px] w-full flex flex-col gap-4 md:gap-6">
